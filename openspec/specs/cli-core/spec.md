...
## Purpose
Defines the CLI entry point, subcommand dispatch, and global flags shared across all `vllm-cli` subcommands. TBD: expand with additional context as the capability evolves.
